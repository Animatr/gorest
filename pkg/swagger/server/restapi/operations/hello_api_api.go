...
func NewHelloAPIAPI(spec *loads.Document) *HelloAPIAPI {
	return &HelloAPIAPI{
		...
		GetImageProductHandler: GetImageProductHandlerFunc(func(params GetImageProductParams) middleware.Responder {
			return middleware.NotImplemented("operation GetImageProduct has not yet been implemented")
		}),
		GetProductProductHandler: GetProductProductHandlerFunc(func(params GetProductProductParams) middleware.Responder {
			return middleware.NotImplemented("operation GetProductProduct has not yet been implemented")
		}),
		CheckPriceHandler: CheckPriceHandlerFunc(func(params CheckPriceParams) middleware.Responder {
			return middleware.NotImplemented("operation CheckPrice has not yet been implemented")
		}),
	}
}
...
type HelloAPIAPI struct {
	...
	// GetImageProductHandler sets the operation handler for the get image product operation
	GetImageProductHandler GetImageProductHandler
	// GetProductProductHandler sets the operation handler for the get product product operation
	GetProductProductHandler GetProductProductHandler
	// CheckPriceHandler sets the operation handler for the check price operation
...
func (o *HelloAPIAPI) Validate() error {
	...
	if o.GetImageProductHandler == nil {
		unregistered = append(unregistered, "GetImageProductHandler")
	}
	if o.GetProductProductHandler == nil {
		unregistered = append(unregistered, "GetProductProductHandler")
	}
	if o.CheckPriceHandler == nil {
		unregistered = append(unregistered, "CheckPriceHandler")
	}
...
func (o *HelloAPIAPI) initHandlerCache() {
	...
	o.handlers["GET"]["/image/{product}"] = NewGetImageProduct(o.context, o.GetImageProductHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/product/{product}"] = NewGetProductProduct(o.context, o.GetProductProductHandler)
	if o.handlers["GET"] == nil {
		o.handlers["GET"] = make(map[string]http.Handler)
	}
	o.handlers["GET"]["/price"] = NewCheckPrice(o.context, o.CheckPriceHandler)
}
